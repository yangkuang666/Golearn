...
//     //请求后端GetProfile为当前用户获取用户信息
//     export function getProfile(): Promise<rental.v1.Profile>{
...
//     //请求后端SubmitProfile提交用户信息
//     export function subProfile(req: rental.v1.IIdentity):  Promise<rental.v1.Profile>{
//         return Coolcar.sendRequestWithAuthRetry({
//             method: 'POST',
//             path: '/v1/profile',
//             data: req,
...
//     //请求后端ClearProfile清理用户信息
//     export function clearProfile(): Promise<rental.v1.Profile>{
//         return Coolcar.sendRequestWithAuthRetry({
//             method: 'DELETE',
//             path: '/v1/profile',
//             respMarshaller: rental.v1.Profile.fromObject
