...
export const auth = $root.auth = (() => {
    ...
    auth.v1 = (function() {
        ...
        v1.AuthSerivce = (function() {

            /**
             * Constructs a new AuthSerivce service.
             * @memberof auth.v1
             * @classdesc Represents an AuthSerivce
             ...
             */
            function AuthSerivce(rpcImpl, requestDelimited, responseDelimited) {
                $protobuf.rpc.Service.call(this, rpcImpl, requestDelimited, responseDelimited);
            }

            (AuthSerivce.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor = AuthSerivce;

            /**
             * Callback as used by {@link auth.v1.AuthSerivce#login}.
             * @memberof auth.v1.AuthSerivce
             ...
             * @param {auth.v1.AuthSerivce.LoginCallback} callback Node-style callback called with the error, if any, and LoginResponse
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(AuthSerivce.prototype.login = function login(request, callback) {
